...
class ShadowDesk{
  ...
  defaultState(now=Date.now()){
    ...
    return{
      ...
      positions:{},setups:{},trades:[],decisions:[],equityHistory:[],audits:{},auditCohorts:{},counters:{decisions:0,entries:0,exits:0,blocked:0},
